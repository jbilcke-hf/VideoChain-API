...
RUN apt --yes install ffmpeg curl build-essential python3 python3-dev python python-dev libx11-dev libxext-dev libxext6 libglu1-mesa-dev xvfb libxi-dev libglew2.1 libglew-dev pkg-config
